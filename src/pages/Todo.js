    ...
    <div className="flex justify-center w-full mt-5">
      <div className="w-4/5 p-6 bg-white rounded-[6px] shadow">
        <div className="flex justify-between mb-3">
          <h1 className="text-center w-3/4 font-semibold text-2xl text-red-600">
            Firebase Todo-List
          </h1>
          <button
            className="p-2 text-blue-400 border-2 order-blue-400 rounded hover:text-white hover:bg-blue-400 text-[12px]"
